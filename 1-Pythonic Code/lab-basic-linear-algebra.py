# 1. vector 간 덧셈 또는 뺄셈 연산을 할 때, 연산이 가능한 사이즈인지를 확인하여 가능 여부를 True 또는 False로 반환함
...
# 2. vector간 덧셈을 실행하여 결과를 반환함, 단 입력되는 vechttp://hyundai-autoevermobilityschool.rapa.or.kr/ft/main.do#tor의 갯수와 크기는 일정하지 않음
